1. Tell me about your self
	...
	3. In current Project iam working in IC role. As part of this role i will be speaking directly with Product Owner and getting user stories in jira board. We are following
	4. standard user stories 1) Requirment Gathering 2) Development 3) Testing 4) Deployment
	5. In current Project Iam working with Pobwer BI and SQl are main skills.
	6. In Power BI the building blocks which iam working are power Query, Power Pivot, Power View, and Power BI Pro and Premium license
...
6. **Name two types of connectivity modes in Power BI?**
      1. Import
      2. Direct Query
7. Explain DAX Function Crossfilter
...
8. How to keep images in Slicer? and filter visulizations based on image selection?
9. How to show negative Values in pie chart?
10. What is HASONEVALUE DAX formula ? Develop Some report?

	https://docs.microsoft.com/en-us/dax/hasonevalue-function-dax

11. How to use **selectedvalue**

	https://docs.microsoft.com/en-us/dax/selectedvalue-function
12. what is ALL dax formula?
13. How to use particulat direction in one mesure calculation?
14. How to implement RLS?
15. How to use Mesure in slicer?

16. How to pass multiple values of disconnected table to visulization?

17. Difference between sum vs sumx in dax.

    https://radacad.com/sum-vs-sumx-what-is-the-difference-of-the-two-dax-functions-in-power-bi

18. common table expression in sql server example
19. Create table from view in sql server?

20. What is query folding in power bi
...
24. Number of unique rows – by multiple columns
...
30. Think and develop below reports.
...
31. Do you know Power BI Rest API?
32. Do you know power Shell commands of Power BI?
...
33. Project Methodology (Agil)
34. Errors rectifing (debugging)
35. What is the definition of L1, L2, L3, L4 support levels in IT Operations Management?
	- https://myfirstsite99.wordpress.com/what-is-the-definition-of-l1-l2-l3-l4-support-levels-in-it-operations-management/
36. Write Sql Query to get running totals.
	```sql
	select empno,sal,
	...
	order by empno
	```
37. Difference between summarize and summarizecolumns
...
38. Explain about data alerts ?
- https://docs.microsoft.com/en-us/power-bi/create-reports/service-set-data-alerts
39. How many types of gateways are available in power BI?
    1. Personal Gateway
    2. Enterprise gateway
40. When we need to gateway?
    1. For on permise data sources(for example Oracle,Sql Server ,MySql,Excel, Notepad ...etc)
41. What are the ticketing tools available ?
    1. Ivanti
    2. Zendesk
    3. Freshservice ....etc
42. What is GetData in PowerBI ?
    1. GetData is a simple icon on PowerBI used to import data from the source.
43. List out some drawbacks/limitations of using PowerBI ?
...
44. Name some commonly used tasks in the query editor ?
    1. Connect to data
